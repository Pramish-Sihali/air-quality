...
export interface ExposureRecord {
  ...
  // Convert exposure data to Nivo line chart format
  ...
  // Convert hourly data to line chart format
  ...
  export function getAqiText(value: number) {
  ...
  export function getCriticalAlert(alerts: Alert[]) {
